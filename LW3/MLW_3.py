...
def services (pdf: FPDF, goods, **kwargs):
    ...
    for id, good in enumerate(goods):
        ...
        pdf.cell(col3_w, 5, f'{good["total"]}{" " + good["total_unit"] if "total_unit" in good else ""}', align='L')
        pdf.cell(col4_w, 5, f'{good["coefficient"]} {"p/" + good["total_unit"] if "total_unit" in good else "p"}', align='L')
        if good['service'] == 'СМС':
            pdf.cell(col5_w, 5, f'{good["coefficient"] * good["total"] - 5} р', align='R')
            total += good["coefficient"] * good["total"] - 5
        ...
        pdf.cell(col5_w, 5, f'{good["coefficient"] * good["total"]} р', align='R')
        total += good["coefficient"] * good["total"]
        height += 5 * len(pdf.multi_cell(col2_w, 100, good['service'], split_only=True))
